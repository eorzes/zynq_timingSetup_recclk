...
#
# Generated by export_simulation on Mon Jun 19 12:16:03 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './m_gth_vio_0.sh' script.

./m_gth_vio_0.sh -reset_run
...
./m_gth_vio_0.sh -noclean_files

For more information on the script, please type './m_gth_vio_0.sh -help'.
