...
#
# Generated by Vivado on Mon Jun 19 12:16:01 +0200 2023
# SW Build 3526262 on Mon Apr 18 15:48:16 MDT 2022
#
# Tool Version Limit: 2022.04 
#
# usage: m_gth.sh [-help]
# usage: m_gth.sh [-lib_map_path]
# usage: m_gth.sh [-noclean_files]
# usage: m_gth.sh [-reset_run]
#
...
# executing this script. Please type 'm_gth.sh -help' for more information.
#
...
# Design libraries
design_libs=(gtwizard_ultrascale_v1_7_13 xil_defaultlib)

# Simulation root library directory
sim_lib_dir="vcs_lib"

# Script info
echo -e "m_gth.sh - Script generated by export_simulation (Vivado v2022.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work gtwizard_ultrascale_v1_7_13 $vlogan_opts +v2k \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../m_gth_ex.gen/sources_1/ip/m_gth/sim/gtwizard_ultrascale_v1_7_gthe4_channel.v" \
    "$ref_dir/../../../../m_gth_ex.gen/sources_1/ip/m_gth/sim/m_gth_gthe4_channel_wrapper.v" \
    "$ref_dir/../../../../m_gth_ex.gen/sources_1/ip/m_gth/sim/m_gth_gtwizard_gthe4.v" \
    "$ref_dir/../../../../m_gth_ex.gen/sources_1/ip/m_gth/sim/m_gth_gtwizard_top.v" \
    "$ref_dir/../../../../m_gth_ex.gen/sources_1/ip/m_gth/sim/m_gth.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.m_gth xil_defaultlib.glbl -o m_gth_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./m_gth_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./m_gth.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key m_gth_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc m_gth_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./m_gth.sh -help\" for more information)\n"
    exit 1
  fi
