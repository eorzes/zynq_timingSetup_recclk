...
#
# Generated by export_simulation on Mon Jun 19 12:14:04 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './AXI_I2C.sh' script.

./AXI_I2C.sh -reset_run
...
./AXI_I2C.sh -noclean_files

For more information on the script, please type './AXI_I2C.sh -help'.
